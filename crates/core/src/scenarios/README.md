...
- **HumidiFi v8** – Proprietary market maker (no published IDL, not Anchor), with price,
  quote-freshness and vault-inventory templates. See
  [protocols/humidifi/README.md](./protocols/humidifi/README.md)
