...
impl TemplateRegistry {
    ...
    pub fn load_tessera_overrides(&mut self) {
        self.load_raw_layout_overrides(TESSERA_V1_OVERRIDES_CONTENT, "tessera");
    }
...
mod tests {
    ...
    fn test_registry_loads_all_protocols() {
        ...
        // + Whirlpool (6) + SPL Token (2) + Pump (2) + PumpSwap (3) + Tessera (6) = 68
        assert_eq!(
            registry.count(),
            68,
            "Registry should load 68 templates total"
        );
