...
mod tests {
    ...
    #[test]
    fn raydium_clmm_price_shock_params_are_camel_case_on_the_wire() {
    ...
    #[tokio::test]
    async fn raydium_clmm_price_shock_rejects_invalid_inputs_before_rpc() {
        let surfpool = Surfpool::new();
